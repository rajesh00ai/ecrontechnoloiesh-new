...
async function registerRoutes(app2) {
  app2.post("/api/contact", async (req, res) => {
    try {
      ...
      res.json({ success: true, data: { id: "placeholder", ...req.body, created_at: /* @__PURE__ */ new Date() } });
    } catch (error) {
  ...
  app2.post("/api/newsletter/subscribe", async (req, res) => {
    try {
      ...
      res.json({ success: true, data: { email: req.body.email, created_at: /* @__PURE__ */ new Date() } });
    } catch (error) {
  ...
  app2.post("/api/event-registrations", async (req, res) => {
    try {
