  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createEventRegistration({
        ...
        certificate_code: `C2C-2025-${Math.floor(Math.random() * 9000) + 1000}`
      });
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center border border-green-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => {
                // Clear the submitted state and form data to allow new registration
              ...
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
            >
              <User size={20} />
